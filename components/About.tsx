      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <span
              className="px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase mb-8 inline-block bg-orange-50 text-orange-600 border border-orange-100"
            >
              About Clentro
            </span>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-5xl font-extrabold mb-2 text-gray-900 tracking-tight">
                    {number}
                    <span className="text-3xl text-orange-500 ml-1">{symbol}</span>
                  </div>
